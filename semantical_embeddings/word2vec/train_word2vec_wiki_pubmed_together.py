import word2vec.wiki.wiki as w
import pickle
import logging
...
WIKIXML = (
    "/workspaces/master_thesis/{lang}wiki-latest-pages-articles-multistream.xml.bz2"
)
...
if __name__ == "__main__":
    ...
    pubmed_sentences = p.PubMedSentences(
        "/workspaces/master_thesis/data/pubmed/pumbed_xml_300_1000/"
    )
